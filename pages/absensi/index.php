                ...
                <div class="card-header">
                  <form method="post" action="">
                    <div class="form-group">
                      <div class="row">
                        <div class="col-3">
                          <input type="date" name="awal" value="<?php echo isset($_POST['awal']) ? $_POST['awal'] : ''; ?>" class="form-control" required>
                        </div>
                        sampai
                        <div class="col-3">
                          <input type="date" name="akhir" value="<?php echo isset($_POST['akhir']) ? $_POST['akhir'] : ''; ?>" class="form-control" required>
                        </div>
                      </div>
                    </div>
